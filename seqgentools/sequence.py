...
class CombinationRange(Sequence):
    ...
    @staticmethod
    def __test__(inputset=None):

        # NOTE: how to make explicit contract of inputset with caller? -> input specification???

        # NOTE: user provides an optional inputset

        # this method use user's inputset or create its own inputset

        # do test using this class's method

        # along the way of testing, this method genrates a pair of input, output set

        # once test is completed, return the set of input and output set to caller 
        ...
        self._iter_equals(CombinationRange(l), combrange)

        return (input, output pairs generated by this method)
